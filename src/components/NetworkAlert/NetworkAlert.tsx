...
const SHOULD_SHOW_ALERT = {
  [SupportedChainId.EVMOS]: true,
  [SupportedChainId.EVMOS_TESTNET]: true,
}

type NetworkAlertChains = keyof typeof SHOULD_SHOW_ALERT

//TODO might want to review those colors just kept the polygon ones
...
const TEXT_COLORS: { [chainId in NetworkAlertChains]: string } = {
  [SupportedChainId.EVMOS]: 'rgba(130, 71, 229)',
  [SupportedChainId.EVMOS_TESTNET]: 'rgba(130, 71, 229)',
}
